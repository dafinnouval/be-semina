...
const getAllTalents = async (req) => {
  ...
  // untuk menampung data yang ingin di filter
  let condition = { organizer: req.user.organizer };

  // ...mengcopy object agar tidak terhapus
  if (keyword) {
...
const updateTalents = async (req) => {
  ...
  // jika id result false / null maka akan menampilkan error tidak `tidak ada pembicara dengan id` yang dikirim client
  if (!result) throw new NotFoundError(`Tidak ada pembicara dengan id : ${id}`);
